**An addon for the Burning Crusade expansion. It will add icons for points of interest to the Outland world map.**

## Features

A quick toggle menu will appear on the Outland world map which allows you to quickly toggle the visibility of any icons added to the world map.
